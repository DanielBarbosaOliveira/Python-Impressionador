...
# Certifique-se de que 'campo_alvo' é o ÚNICO parâmetro aqui
...
# O Entry DEVE vir antes do botão no código
data_moeda = tk.Entry(janela, state='readonly', justify='center')
data_moeda.grid(row=2, column=2, padx=10, pady=10, sticky='nswe')

# Chamada usando lambda sem o nome do parâmetro explicitado (evita conflitos internos do Tkinter)
